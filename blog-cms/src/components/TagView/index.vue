  ...
  <div class="tags-view-container">
    ...
    <ul v-show="visible" :style="{ left: left + 'px', top: top + 'px' }" class="contextmenu">
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">
        <svg-icon icon-class="close" style="width: 1em; height: 1em; vertical-align: -0.12em">关闭其他</svg-icon>
      </li>
      <li @click.stop="closeOtherTags">
        <svg-icon icon-class="circle-close" style="width: 1em; height: 1em; vertical-align: -0.12em">关闭其他</svg-icon>
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <svg-icon icon-class="back" style="width: 1em; height: 1em; vertical-align: -0.12em">关闭左侧</svg-icon>
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <svg-icon icon-class="right" style="width: 1em; height: 1em; vertical-align: -0.12em">关闭右侧</svg-icon>
      </li>
      <li @click.stop="closeAllTags(selectedTag)">
        <svg-icon icon-class="circle-close" style="width: 1em; height: 1em; vertical-align: -0.12em">关闭所有</svg-icon>
      </li>
    </ul>
  </div>
</template>
...
const isFirstView = () => {
  try {
    return (selectedTag.value as TagView).fullPath === tag.visitedViews[1].fullPath || (selectedTag.value as TagView).fullPath === "/index";
  } catch (err) {
    return false;
  }
};
