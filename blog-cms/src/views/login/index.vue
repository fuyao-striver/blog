  ...
  <div class="login">
    <el-form ref="ruleFormRef" :model="loginForm" :rules="rules" class="login-form">
      ...
      <el-form-item prop="password">
        <el-input v-model="loginForm.password" type="password" show-password size="large" placeholder="密码" @keyup.enter="handleLogin(ruleFormRef)">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2026 - {{ new Date().getFullYear() }} By fuyao-striver</span>
    </div>
  </div>
</template>
